...
// 1. NOUVEL IMPORT : Image de Next.js
...
// 2. COMPOSANT IMAGEBLOCK CORRIGÉ AVEC NEXT/IMAGE ET FILL
function ImageBlock({ src, alt, caption }: { src: string; alt: string; caption?: string }) {
  return (
    <figure className="my-12">
      <div className="overflow-hidden rounded-lg">
        {/* Le conteneur doit être relative et avoir un ratio fixe */}
        <div className="relative w-full aspect-[16/9] lg:aspect-[4/3]">
          <Image 
            src={src} 
            alt={alt}
            fill // La solution pour Next.js : l'image remplit son conteneur
            sizes="100vw"
